...
router.get('/victim/:id', (req, res) => {
  Support.findById(req.params.id).populate('comments').exec((err, userWithComments) => {
    if(err){
      ...
      console.log(userWithComments.comments)
       res.render('supportMe/showMore', {user: userWithComments})
    }
  })
})
...
router.get('/supportMe/:id/new', (req, res) => {
...
//Comment Logic
router.post('/support/:id/comments', upload.single('image'), (req, res) => {
...
//Show individual user who need help by ID
// router.get('/supportMe/:id', (req, res) => {
//   Support.findById(req.params.id, (err, foundUser) => {
//     res.send(foundUser)
//   })
// })
