...
router.get('/profile/:id', middleware.isLogin,  (req, res) => {
...
//===========================
router.get('/team', middleware.isLogin,  (req, res) => {
  //res.set('Content-Type', 'image/jpg')
    User.find({}, (err, allUsers) => {
        if(err){
          console.log(err)
...
//1. Get the form
router.get('/support/new', middleware.isLogin, (req, res) => {
...
//=======================================
router.post('/support', middleware.isLogin, upload.single('image'), (req, res) => {
...
router.get('/victims', middleware.isLogin, (req, res) => {
...
router.get('/victim/:id', middleware.isLogin, (req, res) => {
